...
$series_year = $_POST['series_year'];
 


// This is in the PHP file and sends a Javascript alert to the client

echo "<script type='text/javascript'>alert('$series_year');</script>";


$sql = "SELECT Id, created, episodenum, synstat, network, director,writer, name,year 
FROM series WHERE year = '$series_year'";
